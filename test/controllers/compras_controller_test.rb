...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { estado: @compra.estado, fecha: @compra.fecha, proveedor_id: @compra.proveedor_id, user_id: @compra.user_id }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { estado: @compra.estado, fecha: @compra.fecha, proveedor_id: @compra.proveedor_id, user_id: @compra.user_id }
    assert_redirected_to compra_path(assigns(:compra))
  end
