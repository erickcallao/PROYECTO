...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { apellido: @proveedor.apellido, celular: @proveedor.celular, direccion: @proveedor.direccion, nombre: @proveedor.nombre }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { apellido: @proveedor.apellido, celular: @proveedor.celular, direccion: @proveedor.direccion, nombre: @proveedor.nombre }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
